    ...
    <div className="min-h-screen bg-background flex">
      <main className="flex-1 ml-64">
        ...
        <div className="px-12 py-10 max-w-[1440px] mx-auto">
          ...
          {!batch ? (
            <div className="mt-8 rounded-xl border border-dashed border-outline-variant/50 bg-surface-container-lowest px-6 py-16 text-center">
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="bg-surface-container-lowest rounded-xl border border-outline-variant/10 overflow-hidden shadow-[0_4px_6px_-1px_rgba(15,23,42,0.05)]">
                  <div className="p-6 flex items-center gap-4">
                    <div className="w-12 h-12 rounded-lg bg-primary-fixed/30 flex items-center justify-center shrink-0">
